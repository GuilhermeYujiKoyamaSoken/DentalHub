            ...
            <div className="py-4">
                {appointment && (
                    <article>
                        ...
                        <p className="mb-2"><span className="font-semibold">Horário agendado:</span> {appointment.time} </p>
                        ...
                        <section className="bg-gray-100 mt-4 py-2 rounded-md">
                            <p><span className="font-semibold">Serviço:</span> {appointment.service.name} </p>
                            <p><span className="font-semibold">Valor do serviço:</span> {FormatCurrency((appointment.service.price / 100))} </p>
                        </section>
